-- NOTE: get help: `:help` or "<space>sh" to [s]earch the [h]elp documentation,
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      --      vim.keymap.set('n', '<leader>sg', builtin.live_qrep, { desc = '[S]earch by [G]rep' })
